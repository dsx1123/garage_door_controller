...
function load_last_trigger_time(){
    ...
    client.get('http://'+window.location.host+'/app/trigger_time', function(response){
...
function active(){
    ...
    var client = new HttpClient();
    client.get('http://'+window.location.host+'/app/trigger', function(response){
            console.log(response);
            setTimeout(function(){
...
function load_door_status(){
    var prg_bar = document.getElementById("status");
    var client = new HttpClient();
    return client.get('http://'+window.location.host+'/app/state', function(response){
                console.log(response);
